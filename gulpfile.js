...
var target = {
	...
	js_lint_src : [
		'docroot/assets/js/script.js'
	],
	js_concat_src : [
		'docroot/assets/js/jquery.js',
		'docroot/assets/js/script.js'
	],
	js_dest : 'docroot/assets/js'
};
...
gulp.task('browser-sync', function() {
	browserSync.init(['docroot/assets/css/*.css', 'docroot/assets/js/*.js'], {
...
gulp.task('default', function() {
	...
	gulp.watch('docroot/assets/js/*.js', function() {
		gulp.run('js-lint');
	});
});